...
use proc_macro2::{Group, Literal, Punct, Span, TokenTree};
use quote::quote;
use syn::{
    braced, bracketed,
...
pub fn implement_polymorphic(input: TokenStream) -> TokenStream {
    ...
    let base_attr = [
        ...
        TokenTree::Group(Group::new(
            ...
            [
                TokenTree::Ident(Ident::new("base", Span::call_site())),
                TokenTree::Punct(Punct::new('=', proc_macro2::Spacing::Alone)),
                TokenTree::Literal(Literal::usize_unsuffixed(base_fields_count)),
            ]
            .into_iter()
